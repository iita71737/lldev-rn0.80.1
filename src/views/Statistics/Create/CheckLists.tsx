...
import { Text, View, ScrollView, FlatList, InteractionManager } from 'react-native'
import {
  WsText,
  WsFlex,
  WsTag,
...
const CheckLists: React.FC<CheckListFrequencyProps> = (props) => {
